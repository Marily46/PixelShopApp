          ...
          {product ? (
            <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-8">
              ...
              <div className="mt-4 md:mt-0">
                ...
                <strong className="text-lg text-gray-900 mt-2">${product.price}</strong>
                ...
                <span className="block mt-2 text-gray-500">{product.rating.count > 10 ? 'In Stock' : 'Out of Stock'}</span>
                <button 
